...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/printerd

dist/Release/GNU-Linux-x86/printerd: ${OBJECTFILES}
...
${OBJECTDIR}/http_server.o: nbproject/Makefile-${CND_CONF}.mk http_server.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/http_server.o http_server.c

${OBJECTDIR}/port_operations.o: nbproject/Makefile-${CND_CONF}.mk port_operations.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/port_operations.o port_operations.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/printerd
